...
class OBS {
  constructor() {
    _defineProperty(this, "socket", new ObsWebSocket());
...
})(ChromaKeyColorType || (ChromaKeyColorType = {}));
...
})(ColorKeyColorType || (ColorKeyColorType = {}));
...
})(MaskBlendSelect || (MaskBlendSelect = {}));
...
})(NoiseSuppressMethod || (NoiseSuppressMethod = {}));
...
export { Alignment, ApplyLUTFilter, ApplyLutFilter, AspectRatioFilter, BrowserSource, BrowserSourceItem, ChromaKeyColorType, ChromaKeyFilter, ColorCorrectionFilter, ColorKeyColorType, ColorKeyFilter, ColorSource, CompressorFilter, CropPadFilter, DEFAULT_SCENE_ITEM_PROPERTIES, DisplayCaptureSource, ExpanderDetectorType, ExpanderFilter, ExpanderPreset, Filter, FreetypeTextSource, GDIPlusTextSource, GainFilter, ImageMaskBlendFilter, ImageSource, InvertPolarityFilter, LimiterFilter, LumaKeyFilter, MaskBlendSelect, MediaSource, NoiseGateFilter, NoiseSuppressFilter, NoiseSuppressMethod, RenderDelayFilter, Scene, SceneItem, ScrollFilter, SharpenFilter, Source, VideoCaptureSource, obs };
